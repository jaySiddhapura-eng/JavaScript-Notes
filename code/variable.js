 ...
 let firstVariable, lastVariable;
 let firstVar = 1, lastVar;
 //let firstVar = 'string', lastVar = 1;
 ...
 // dynamic typing
 // type of variable can be changed on the runtime
 ...
 console.log('type of undefined variable : '+ typeof undefinedVariable);       // is also undefined
